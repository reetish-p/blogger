...
import com.example.blogger.tags.TagServiceImpl;
...
public class ArticleServiceImpl {
    ...
    public ArticleServiceImpl(ArticleRepository articlesRepository, CommentRepository commentRepository, TagServiceImpl tagServiceImpl) {
    ...
    public ArticleEntity createArticle(String articleTitle, String articleDescription, String articleBody, List<String> articleTagsList, UserEntity currentLoggedInUser){
        var articleTagEntities = tagServiceImpl.createTags(articleTagsList);
